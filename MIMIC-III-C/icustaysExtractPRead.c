...
void ICUSTAY_table_read()
{
    ...
    ICUSTAY_TABLE = (struct ICUSTAY_DATA *)malloc(76540 * sizeof(struct ICUSTAY_DATA));
    unsigned int data_size = 0;
    memset(ICUSTAY_TABLE, 0, 76540 * sizeof(struct ICUSTAY_DATA));
